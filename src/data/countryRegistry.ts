...
export const COUNTRY_REGISTRY: CountryRegistryItem[] = [
  ...
  // Southeast Asia
  { id: 'PHL', name: 'Philippines', alpha2: 'PH', alpha3: 'PHL', numeric: '608', officialName: 'Republic of the Philippines', region: 'Southeast Asia', sovereignAiStatus: 'Developing Policy', dataCenterCapacityMW: 450, gridReadinessScore: 71, activeProjectsCount: 16, aliases: ['PH', 'Filipinas'], enabled: true },
  ...
  { id: 'NLD', name: 'Netherlands', alpha2: 'NL', alpha3: 'NLD', numeric: '528', officialName: 'Kingdom of the Netherlands', region: 'Europe', sovereignAiStatus: 'Constrained', dataCenterCapacityMW: 1200, gridReadinessScore: 78, activeProjectsCount: 12, aliases: ['NL', 'Amsterdam Hub'], enabled: true },
  { id: 'NOR', name: 'Norway', alpha2: 'NO', alpha3: 'NOR', numeric: '578', officialName: 'Kingdom of Norway', region: 'Europe', sovereignAiStatus: 'Emerging Hub', dataCenterCapacityMW: 650, gridReadinessScore: 98, activeProjectsCount: 11, aliases: ['NO', 'Nordic Hub'], enabled: true },
  ...
  { id: 'IND', name: 'India', alpha2: 'IN', alpha3: 'IND', numeric: '356', officialName: 'Republic of India', region: 'South Asia', sovereignAiStatus: 'Active Strategy', dataCenterCapacityMW: 1850, gridReadinessScore: 79, activeProjectsCount: 45, aliases: ['IN', 'Mumbai Hub'], enabled: true },
