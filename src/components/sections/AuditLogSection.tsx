      ...
      <div className="flex flex-wrap items-center justify-between gap-4 pb-4 border-b border-slate-800">
        ...
        <div className="flex items-center space-x-2">
          ...
          <select
            ...
            className="bg-slate-900 border border-slate-700 rounded-xl px-3 py-2 text-xs text-slate-200 focus:outline-none focus:ring-2 focus:ring-cyan-500 cursor-pointer"
          >
          ...
          <GlassCard key={entry.id} className="p-6 space-y-4 border-l-4 border-l-cyan-500">
            <div className="flex flex-wrap items-center justify-between gap-2 border-b border-slate-800/80 pb-3">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-xs font-mono text-slate-400">ID: {entry.id}</span>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
              <div className="p-3.5 rounded-xl bg-slate-950/80 border border-slate-800 space-y-1">
                <span className="text-[10px] font-mono text-slate-400 uppercase tracking-wider block">Baseline Original Claim</span>
                <p className="text-slate-300 italic">{entry.originalClaim}</p>
              </div>
              ...
              <div className="p-3.5 rounded-xl bg-cyan-950/20 border border-cyan-500/30 space-y-1">
                ...
                <p className="text-white font-medium">{entry.updatedFinding}</p>
              </div>
            </div>

            <div className="space-y-1 text-xs">
              <span className="text-slate-400 font-mono block">Verification Rationale & Evidence:</span>
